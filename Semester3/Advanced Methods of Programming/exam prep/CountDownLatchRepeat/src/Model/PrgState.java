...
public class PrgState {
    ...
    private InterfaceTable<Integer,Integer> latchTable;
    ...
    public PrgState(IStmt initialProgram){
        ...
        this.latchTable = new TableClass();
    ...
    public InterfaceTable<Integer, Integer> getLatchTable() {
        return latchTable;
    }

    public PrgState(InterfaceStack<IStmt> exeStack, InterfaceList<Value> output, InterfaceDictionary<String, Value> symTable, InterfaceDictionary<StringValue,BufferedReader> fileTable, InterfaceHeap heap, InterfaceTable<Integer,Integer> latchTable) {
