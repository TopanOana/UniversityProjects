...
public class StatementListController implements Initializable{
    ...
    private List<IStmt> buildProgramStatements(){
        ...
        IStmt ex10 = new CompStmt(new VarDeclStmt("v", new IntType()), new CompStmt(new AssignStmt("v", new ValueExp(new IntValue(20))),
                new CompStmt(new WaitStmt(new IntValue(10)), new PrintStmt(new ArithExp("*", new VarExp("v"), new ValueExp(new IntValue(10)))))));


        IStmt ex11 = new CompStmt(new VarDeclStmt("v1", new IntType()), new CompStmt(new VarDeclStmt("v2", new IntType()), new CompStmt(
