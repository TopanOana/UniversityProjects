...
public class PrgState {
    ...
    private InterfaceTable<Integer, Triple<Integer, ArrayList<Integer>, Integer>> semaphoreTable;
    ...
    public PrgState(IStmt initialProgram){
        ...
        this.semaphoreTable = new TableClass();
    ...
    public InterfaceTable<Integer, Triple<Integer, ArrayList<Integer>, Integer>> getSemaphoreTable() {
        return semaphoreTable;
    }

    public PrgState(InterfaceStack<IStmt> exeStack, InterfaceList<Value> output, InterfaceDictionary<String, Value> symTable, InterfaceDictionary<StringValue,BufferedReader> fileTable, InterfaceHeap heap, InterfaceTable<Integer, Triple<Integer, ArrayList<Integer>, Integer>> semaphoreTable) {
