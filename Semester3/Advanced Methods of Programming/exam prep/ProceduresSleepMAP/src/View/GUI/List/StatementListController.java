...
public class StatementListController implements Initializable{
    ...
    private List<IStmt> buildProgramStatements(){
        ...
        IStmt ex11 = new CompStmt(new VarDeclStmt("v", new IntType()), new CompStmt(new AssignStmt("v", new ValueExp(new IntValue(0))), new CompStmt(
                new WhileStmt(new RelExp("<", new VarExp("v"), new ValueExp(new IntValue(3))), new CompStmt(
                        ...
                        new AssignStmt("v", new ArithExp("+", new VarExp("v"), new ValueExp(new IntValue(1)))))), new CompStmt(
                                new SleepStmt(5), new PrintStmt(new ArithExp("*", new VarExp("v"), new ValueExp(new IntValue(10))))
        )
        )));

        ArrayList<Expression> sumCall = new ArrayList<>();
        sumCall.add(new ArithExp("*", new VarExp("v"), new ValueExp(new IntValue(10))));
        sumCall.add(new VarExp("w"));

        ArrayList<Expression> broadcast = new ArrayList<>();
        broadcast.add(new VarExp("v"));
        broadcast.add(new VarExp("w"));

        IStmt ex10 = new CompStmt(new VarDeclStmt("v", new IntType()), new CompStmt(new VarDeclStmt("w", new IntType()),
