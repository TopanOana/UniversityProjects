...
public class PrgState {
    ...
    private InterfaceTable lockTable;
    ...
    public InterfaceTable getLockTable(){return lockTable;}
    ...
    public PrgState(InterfaceStack<IStmt> exeStack, InterfaceList<Value> output, InterfaceDictionary<String, Value> symTable, InterfaceDictionary<StringValue,BufferedReader> fileTable, InterfaceHeap heap, InterfaceTable lockTable) {
