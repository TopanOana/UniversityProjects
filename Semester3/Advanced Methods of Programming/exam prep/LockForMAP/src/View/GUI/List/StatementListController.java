...
public class StatementListController implements Initializable{
    ...
    private List<IStmt> buildProgramStatements(){
        ...
        IStmt ex10 = new CompStmt(new VarDeclStmt("v1",new RefType(new IntType())), new CompStmt(new VarDeclStmt("v2",new RefType(new IntType())),
                new CompStmt(new NewStmt("v1",new ValueExp(new IntValue(20))), new CompStmt(new NewStmt("v2",new ValueExp(new IntValue(30))),
                        new CompStmt(new NewLockStmt("x"), new CompStmt(new ForkStmt(
                                new CompStmt(new ForkStmt(
                                        ...
                                        new CompStmt(new ForkStmt(new WriteHeapStmt("v2", new ArithExp("+", new ReadHeapExp(new VarExp("v2")),new ValueExp(new IntValue(1))))),
                                ...
                                new CompStmt(new NopStmt(),new CompStmt(new NopStmt(), new CompStmt(new NopStmt(), new CompStmt(new NopStmt(), new CompStmt(new NopStmt(), new CompStmt(
                                        ...
                                        new PrintStmt(new ReadHeapExp(new VarExp("v1"))), new PrintStmt(new ReadHeapExp(new VarExp("v2"))))))))))))))))))));


        IStmt ex11 = new CompStmt(new VarDeclStmt("v", new IntType()), new ForStmt("v", new ValueExp(new IntValue(0)), new ValueExp(new IntValue(3)), new ArithExp("+", new VarExp("v"), new ValueExp(new IntValue(1))),new PrintStmt(new VarExp("v"))));

        IStmt ex12 = new CompStmt(new VarDeclStmt("v", new IntType()), new CompStmt(new AssignStmt("v", new ValueExp(new IntValue(20))), new CompStmt(
