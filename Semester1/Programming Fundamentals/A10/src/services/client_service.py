...
class ClientService:
    ...
    def search_for_client_by_id(self, partial_client_id):
        ...
        list_of_results = self.client_repo._list_of_clients.filter_function(list_of_clients, src.iterating_structure.data_structure.IteratorData.accept_id, partial_client_id)

        #for client in list_of_clients:
         #   if partial_client_id in str(client.id):
    ...
    def search_for_client_by_name(self, partial_name):
        ...
        list_of_clients = self.client_repo.get_all_clients()
        list_of_results = self.client_repo._list_of_clients.filter_function(list_of_clients,
                                                                            src.iterating_structure.data_structure.IteratorData.accept_name,
                                                                            partial_name)
    ...
    def sort_clients_by_name(self):
        self.client_repo._list_of_clients.comb_sort(self.client_repo._list_of_clients._data, src.iterating_structure.data_structure.IteratorData.compare_name)

    def sort_clients_by_id(self):
        self.client_repo._list_of_clients.comb_sort(self.client_repo._list_of_clients._data, src.iterating_structure.data_structure.IteratorData.compare_id)
