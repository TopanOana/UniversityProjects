import src.iterating_structure.data_structure
...
class BookService:
    def __init__(self, book_repo, undo_redo_repo,Repo_access):
    ...
    def add_book_to_list(self, title, author):
        ...
        undo_event = UndoEvent(self.repo_access.remove_book, book_id, self.repo_access.add_book, book, self.book_repo)
    ...
    def remove_book_from_list(self, book_id):
        ...
        """
        """for the undo/redo functionality"""
        undo_event = UndoEvent(self.repo_access.add_book, self.book_repo[book_id], self.repo_access.remove_book,
    ...
    def update_book_from_list(self, book_id, title_new, author_new):
        ...
        if self.book_repo.unique_book_id(book_id) is False:
            ...
            undo_event = UndoEvent(self.repo_access.update_book, undo_parameters, self.repo_access.update_book, redo_parameters,
                                   self.book_repo)
            self.undo_redo_repo.add_event_to_list(undo_event)
            """actual update"""
    ...
    def search_for_book_by_id(self, partial_book_id):
        ...
        list_result_of_search = self.book_repo._list_of_books.filter_function(list_of_books, src.iterating_structure.data_structure.IteratorData.accept_id, partial_book_id)

        #for book in list_of_books:
            #if partial_book_id in str(book.id):
    ...
    def search_for_book_by_title(self, partial_title):
        ...
        list_result_of_search = []
        list_of_books = self.book_repo.get_all_books()
        list_result_of_search = self.book_repo._list_of_books.filter_function(list_of_books,
                                                                              src.iterating_structure.data_structure.IteratorData.accept_title,
                                                                              partial_title)
    ...
    def search_for_book_by_author(self, partial_author):
        ...
        list_of_books = self.book_repo.get_all_books()
        list_result_of_search = self.book_repo._list_of_books.filter_function(list_of_books,
                                                                              src.iterating_structure.data_structure.IteratorData.accept_author,
                                                                              partial_author)
    ...
    def sort_by_id(self):
        self.book_repo._list_of_books.comb_sort(self.book_repo._list_of_books._data, src.iterating_structure.data_structure.IteratorData.compare_id)

    def sort_by_title(self):
        self.book_repo._list_of_books.comb_sort(self.book_repo._list_of_books._data, src.iterating_structure.data_structure.IteratorData.compare_title)

    def sort_by_author(self):
        self.book_repo._list_of_books.comb_sort(self.book_repo._list_of_books._data, src.iterating_structure.data_structure.IteratorData.compare_author)
