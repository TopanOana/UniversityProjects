...
class UI:
    def __init__(self, undo_redo_repo, book_repo, client_repo, rental_repo, book_service, client_service, rental_service):
        """Undo/Redo service"""
    ...
    def statistic_most_rented_books(self):
        ...
        for book in most_rented_books:
            print(str(book.book)+" - "+str(book.number_of_rentals))
    ...
    def statistic_most_active_clients(self):
        ...
        for client in most_active_clients:
            print(str(client.client) + " - "+str(client.number_of_rentals))
    ...
    def statistic_most_rented_authors(self):
        ...
        for i in range(0, len(list_of_authors)):
            print(list_of_authors[i].author + " - "+str(list_of_authors[i].number_of_rentals))
    ...
    def print_sixth_menu(self):
        print("1. Sort books by id")
        print("2. Sort books by title")
        print("3. Sort books by author")
        print("4. Sort clients by id")
        print("5. Sort clients by name")
        print("6. Back to main menu")

    def choose_from_sixth_menu(self):
        self.print_sixth_menu()
        user_input = input("Choose an option: ").strip()
        if user_input == "1":
            ...
            self.sort_clients_by_id()
        elif user_input == "5":
            self.sort_clients_by_name()
        elif user_input == "6":
            return
        else:
            print("option unavailable")
    ...
    def sort_books_by_id(self):
        self._book_service.sort_by_id()
        list_of_books = self._book_repo.get_all_books()
        for book in list_of_books:
            print(str(book))

    def sort_books_by_title(self):
        self._book_service.sort_by_title()
        list_of_books = self._book_repo.get_all_books()
        for book in list_of_books:
            print(str(book))

    def sort_books_by_author(self):
        self._book_service.sort_by_author()
        list_of_books = self._book_repo.get_all_books()
        for book in list_of_books:
            print(str(book))

    def sort_clients_by_id(self):
        self._client_service.sort_clients_by_id()
        list_of_clients = self._client_repo.get_all_clients()
        for client in list_of_clients:
            print(str(client))

    def sort_clients_by_name(self):
        self._client_service.sort_clients_by_name()
        list_of_clients = self._client_repo.get_all_clients()
        for client in list_of_clients:
            print(str(client))
