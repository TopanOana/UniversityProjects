...
class ClientService:
    def __init__(self, client_repo, undo_redo_repo):
    ...
    def add_client_to_list(self, name):
        ...
        undo_event = UndoEvent(ClientRepository.remove_client, client_id, ClientRepository.add_client, client, self.client_repo)
    ...
    def remove_client_from_list(self, client_id):
        ...
        undo_event = UndoEvent(ClientRepository.add_client, self.client_repo[client_id], ClientRepository.remove_client, client_id, self.client_repo)
        self.undo_repo_repo.add_event_to_list(undo_event)
        """actual deletion"""
    ...
    def update_client_from_list(self, client_id, name_new):
        ...
        if self.client_repo.unique_client_id(client_id) is False:
            ...
            undo_event = UndoEvent(ClientRepository.update_client, parameters_undo, ClientRepository.update_client, parameters_redo, self.client_repo)
            self.undo_repo_repo.add_event_to_list(undo_event)
        """actual update"""
