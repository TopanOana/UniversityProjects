...
Validation_exception_inherited::Validation_exception_inherited(std::string _message) : message{_message }
{
}

const char * Validation_exception_inherited::what() const noexcept
{
