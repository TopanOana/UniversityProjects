...
void UserInterface::print_menu() {
    ...
    std::cout<<"20. Exit.\n";
    std::cout<<"21. LAB 4 SCHEDULING PROBLEM. \n";
}
    ...
    while(true)
    {
        ...
        switch (option){
            ...
            case 20:
                return;
            case 21:
                lab_4_scheduling_problem();
        }
    }
}

void UserInterface::lab_4_scheduling_problem() {
    scheduling_problem("C:/Users/Oana/Documents/GitHub/Graph-Algo/graph_algo_sem2/LAB4/GraphAlgoPW4/test_graph.txt");
}
