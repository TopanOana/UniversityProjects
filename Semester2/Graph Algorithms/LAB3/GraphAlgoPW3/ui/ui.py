...
class UserInterface:
    ...
    def minimum_cost_path(self):
        ...
        try:
            lowest_cost, path = minimum_cost_path(self.graph, start_vertex, end_vertex)
            print("The lowest cost path is: " + str(lowest_cost))
            print("The path of the lowest cost walk is: ")
